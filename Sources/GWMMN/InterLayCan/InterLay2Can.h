...
#ifndef INTERLAY2CAN_H_
#define INTERLAY2CAN_H_
...
/*indicate nm normal*/
extern void APPlIL2_RXComplete(uint32 u32Id);
extern void APPlIL2_TXComplete(uint8 u8IfId);
extern void APPlIL2_RecTimeOut(uint32 u32Id);
extern BOOL APPlIL2_TXStart(uint8 u8IfId);
